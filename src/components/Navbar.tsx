          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a
                ...
                className="bg-brand-500 hover:bg-brand-600 text-black px-4 py-2 rounded-full text-sm font-bold transition-colors flex items-center gap-2 shadow-[0_0_15px_rgba(0,229,255,0.3)]"
              >
